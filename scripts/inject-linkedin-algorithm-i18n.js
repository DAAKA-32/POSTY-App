/**
 * One-shot script to inject 8 language translations (de, es, it, ja, ko,
 * nl, pt, zh) into app/(seo)/linkedin-algorithm/translations.ts.
 *
 * The file already has `en` and `fr` blocks. This script appends the 8
 * missing languages before the closing `};` of the translations object.
 *
 * Idempotent: if `de:` is already present in the file, the script exits
 * without changes.
 */
...
// Translations for 8 languages — keeping content quality close to the EN
// version. Terms specific to LinkedIn engineering (dwell time, seed audience,
// viral distribution) are preserved as technical terms where appropriate.
const langs = {
  de: {
    meta: {
    ...
    tldr: {
      label: "TL;DR",
      body: "LinkedIn bewertet jeden Beitrag in 4 Phasen: Qualitätsprüfung, Test auf kleinem Seed-Publikum, Engagement-Bewertung, dann virale Verteilung bei starken Signalen. Die wichtigsten Signale — in Reihenfolge — sind aussagekräftige Kommentare, Dwell Time, thematische Kohärenz, Creator-Autorität und Verbindungsstärke. Alles andere ist Rauschen.",
    },
    phasesSection: {
    ...
    mythsSection: {
      ...
      subtitle:
        "Diese Behauptungen kommen jedes Jahr. Keine hält echten Daten stand.",
      mythLabel: "Mythos",
    ...
    internalLinks: [
      { label: "LinkedIn-Beitragsideen", href: "/linkedin-post-ideas" },
      { label: "LinkedIn-Beitragsbeispiele", href: "/linkedin-post-examples" },
      { label: "LinkedIn-Beitragsgenerator", href: "/ai-linkedin-post-generator" },
      { label: "LinkedIn-Beitrag schreiben", href: "/write-linkedin-post" },
  ...
  es: {
    ...
    tldr: {
      label: "TL;DR",
      body: "LinkedIn puntúa cada post en 4 fases: control de calidad, prueba en audiencia seed, evaluación de engagement, luego distribución viral si las señales son fuertes. Las señales más importantes — en orden — son comentarios significativos, dwell time, relevancia del contenido, autoridad del creador y fuerza de conexión. Lo demás es ruido.",
    },
    phasesSection: {
    ...
    mythsSection: {
      ...
      subtitle:
        "Estas afirmaciones se propagan cada año. Ninguna se sostiene frente a datos reales.",
      mythLabel: "Mito",
    ...
    internalLinks: [
      { label: "Ideas de posts de LinkedIn", href: "/linkedin-post-ideas" },
      { label: "Ejemplos de posts de LinkedIn", href: "/linkedin-post-examples" },
      { label: "Generador de posts de LinkedIn IA", href: "/ai-linkedin-post-generator" },
      { label: "Escribir un post de LinkedIn", href: "/write-linkedin-post" },
      { label: "Registro gratis", href: "/signup" },
    ],
  ...
  it: {
    ...
    tipsSection: {
      ...
      subtitle:
        "Non sono hack. I pattern che correlano con il reach su migliaia di post analizzati nel 2025 e 2026.",
      tips: [
        {
    ...
    mythsSection: {
      ...
      subtitle:
        "Queste affermazioni si diffondono ogni anno. Nessuna regge contro dati reali.",
      mythLabel: "Mito",
      realityLabel: "Realtà",
      myths: [
        {
    ...
    internalLinks: [
      { label: "Idee post LinkedIn", href: "/linkedin-post-ideas" },
      { label: "Esempi post LinkedIn", href: "/linkedin-post-examples" },
      { label: "Generatore post LinkedIn IA", href: "/ai-linkedin-post-generator" },
      { label: "Scrivi un post LinkedIn", href: "/write-linkedin-post" },
      { label: "Registrazione gratuita", href: "/signup" },
    ],
  ...
  pt: {
    ...
    mythsSection: {
      ...
      subtitle:
        "Essas afirmações se espalham a cada ano. Nenhuma se sustenta diante de dados reais.",
      mythLabel: "Mito",
    ...
    internalLinks: [
      { label: "Ideias de posts LinkedIn", href: "/linkedin-post-ideas" },
      { label: "Exemplos de posts LinkedIn", href: "/linkedin-post-examples" },
      { label: "Gerador de posts LinkedIn IA", href: "/ai-linkedin-post-generator" },
      { label: "Escrever um post LinkedIn", href: "/write-linkedin-post" },
      { label: "Cadastro grátis", href: "/signup" },
    ],
  ...
  nl: {
    ...
    tldr: {
      label: "TL;DR",
      body: "LinkedIn scoort elke post in 4 fases: kwaliteitscontrole, test op seed-publiek, engagement-evaluatie, dan virale distributie als de signalen sterk zijn. De belangrijkste signalen — in volgorde — zijn betekenisvolle reacties, dwell time, contentrelevantie, creator-autoriteit en verbindingssterkte. De rest is ruis.",
    },
    phasesSection: {
    ...
    tipsSection: {
      ...
      subtitle:
        "Geen hacks. De patronen die correleren met bereik over duizenden posts geanalyseerd in 2025 en 2026.",
      tips: [
        {
    ...
    mythsSection: {
      ...
      subtitle:
        "Deze claims verspreiden zich elk jaar. Geen houdt stand tegen echte data.",
      mythLabel: "Mythe",
    ...
    internalLinks: [
      { label: "LinkedIn-postideeën", href: "/linkedin-post-ideas" },
      { label: "LinkedIn-postvoorbeelden", href: "/linkedin-post-examples" },
      { label: "LinkedIn-postgenerator AI", href: "/ai-linkedin-post-generator" },
      { label: "Schrijf een LinkedIn-post", href: "/write-linkedin-post" },
      { label: "Gratis aanmelden", href: "/signup" },
    ],
  ...
  zh: {
    meta: {
      ...
      description:
        "LinkedIn 算法在 2026 年如何对帖子进行排名 —— 4 个分发阶段、5 个关键排名信号、今年发生了什么变化，以及 7 个经过验证仍然有效的策略。",
    },
    ...
    heroSubtitle:
      "LinkedIn 没有公开其排名代码，但十年的工程博客、专利文件和一致的创作者实验已经确定了它的实际运作方式。这里是实用的无废话版本。",
    ctaPrimary: "用 AI 写出更好的帖子",
    ctaSecondary: "查看详细分解",
    tldr: {
      label: "简要",
      body: "LinkedIn 在 4 个阶段对每个帖子进行评分：质量检查、在小范围种子受众中测试、评估互动，然后在信号强烈时进行病毒式分发。最重要的信号 —— 按顺序 —— 是有意义的评论、停留时间、内容相关性、创作者权威性和连接强度。其余都是噪音。",
    },
    phasesSection: {
      title: "4 个分发阶段",
      subtitle:
        "你的帖子在到达大量受众之前会经过 4 个自动检查点。了解每一个会告诉你实际在哪里失去覆盖率。",
      phases: [
        {
          title: "质量检查（垃圾邮件过滤）",
          description:
            "发布后几秒钟内，LinkedIn 会通过分类器运行帖子，标记垃圾邮件、低质量或违规内容。过多的主题标签、没有上下文的外部链接、通用的互动诱饵或 AI 明显的模式会在此处被降级 —— 通常是悄悄地。",
          outcomeLabel: "结果",
        ...
        },
        {
          title: "种子受众测试",
          description:
            "该帖子会向您网络的一小部分（50 到几百人）显示 —— 按连接强度、过去互动和主题相关性选择。此测试窗口的前 60 分钟至关重要。",
          outcomeLabel: "结果",
        ...
        },
        {
          title: "互动评估",
          description:
            "LinkedIn 权衡种子测试期间发生的事情：评论与查看比率、停留时间、分享量、互动个人资料的权威性。活跃创作者的有意义评论的价值远远超过被动点赞。",
          outcomeLabel: "结果",
    ...
    signalsSection: {
      title: "真正改变局面的 5 个信号",
      subtitle:
        "LinkedIn 考虑了数十个因素。实际上，这五个因素解释了为什么一个帖子起飞而另一个没有的 90% 原因。",
      signals: [
        {
          emoji: "\u{1F4AC}",
          title: "有意义的评论",
          description:
            "不是表情符号，不是单字回复。实质性的评论 —— 特别是那些引发来回交流的 —— 表明您的内容值得停留。单一最重要的正面信号。",
          weightLabel: "最高权重",
        },
        {
          emoji: "\u{23F1}\u{FE0F}",
          title: "停留时间",
          description:
            "人们在您的帖子上停止滚动的时间长度。保持注意力的长帖子胜过被略过滚动的短帖子。点击「查看更多」是可衡量的代理指标。",
          weightLabel: "高",
        },
        {
          emoji: "\u{1F3AF}",
          title: "内容相关性",
          description:
            "算法将您的主题与每个观众推断出的兴趣相匹配。保持在一致细分领域的帖子建立主题权威，随着时间推移会被展示给更紧密、更相关的受众。",
          weightLabel: "高",
        },
        {
          emoji: "\u{1F3C6}",
          title: "创作者权威",
          description:
            "LinkedIn 跟踪您的历史互动率、发帖频率、网络质量。有稳定互动的持续创作者在每个帖子上都会获得基础提升。",
          weightLabel: "中",
        },
        {
          emoji: "\u{1F517}",
          title: "连接强度",
          description:
            "按过去的互动加权 —— 之前点赞或评论过您的帖子的人在种子受众中被高度优先。重新连接休眠联系人会让您损失早期窗口的互动。",
          weightLabel: "中",
        },
      ],
    },
    recentChanges: {
      title: "2026 年的变化",
      subtitle:
        "LinkedIn 一直在大力重新调整分发。今年的四项变化对您实际应该发布的内容影响最大。",
      changes: [
        {
          label: "2026 年第一季度",
          title: "外部链接惩罚减轻",
          description:
            "带有外部链接的帖子不再自动受限。LinkedIn 开始在帖子本身获得足够停留时间时奖励链接 —— 实际上要求链接由内容赢得。",
        },
        {
          label: "2026 年第二季度",
          title: "视频在专业主题上获得优先",
          description:
            "短竖屏视频（不到 90 秒）在 B2B/职业主题上的覆盖率比纯文本高 2 到 3 倍。前 3 秒的字幕和强力钩子比制作质量更重要。",
        },
        {
          label: "持续",
          title: "AI 生成内容检测",
          description:
            "具有通用 AI 模式（过度列表、模板化开头、空洞的思想领导力）的帖子越来越被降级。解决方法：具体性 —— 真实姓名、真实数字、真实亲身经历。",
        },
        {
          label: "持续",
          title: "评论质量加权",
          description:
            "超过 12 个词的评论比短评论重要得多。相互评论循环（pod）仍可检测并被贬值 —— 有机深度胜出。",
        },
      ],
    },
    tipsSection: {
      ...
      subtitle:
        "这些不是黑客。这些是在 2025 年和 2026 年分析的数千个帖子中与覆盖率相关的模式。",
      tips: [
        {
          title: "赢得前 60 分钟",
          description:
            "在您的核心受众真正在线时发布。您的帖子在第一个小时获得的互动决定了它是否能通过种子受众测试。查看您的分析以了解您的个人高峰时段。",
        },
        {
          title: "前 2 行的钩子",
          description:
            "这是「查看更多」之前唯一可见的行。具体的、意想不到的或略带反对的开头会触发点击 —— LinkedIn 将其衡量为停留时间。",
        },
        {
          title: "触发评论，而不只是点赞",
          description:
            "以需要意见的问题结束帖子，而不是是/否。在前 2 小时内回复每一条评论以保持线程活跃 —— 线程深度是强烈信号。",
        },
        {
          title: "每周持续发布 3 到 5 次",
          description:
            "创作者权威会累积。连续 3 个月周一-周三-周五发帖胜过第 1 周发 20 个帖子然后沉默。LinkedIn 奖励持续出现的创作者。",
        },
        {
          title: "在明确的细分领域坚持 6 个月",
          description:
            "在不相关的主题之间跳跃会重置您的主题权威。选择一条狭窄的车道并主导它 —— 算法最终会将您的帖子推送给关心的人。",
        },
        {
          title: "使用原生格式，而不是转发",
          description:
            "原创文本、原生视频、原生文档和原生投票都胜过链接分享。文档（PDF 轮播）的平均停留时间特别高。",
        },
        {
          title: "像人一样写作，而不是像 LinkedIn",
          description:
            "公式化的「领导力」帖子、空洞的励志内容和明显的 ChatGPT 结构会被降级。具体的故事、不寻常的观点和独特的经历会得到奖励。",
        },
      ],
    },
    mythsSection: {
      ...
      myths: [
        {
          ...
          reality:
            "3 到 5 个相关主题标签可以。超过这个数量，垃圾邮件分类器就会启动并限制分发。主题标签是一个小的相关性信号，而不是覆盖率乘数。",
        },
        {
          claim: "外部链接会扼杀你的覆盖率",
          reality:
            "不再是了。自 2026 年第一季度起，LinkedIn 在决定限制之前测量停留时间。一个写得很好、带有上下文链接的帖子胜过一个没有链接但没有实质内容的帖子。",
        },
        {
          claim: "有一个最佳发布时间",
          reality:
            "有一个最适合您的受众的时间。通用的「周二早上 8 点」建议毫无价值 —— 查看您的连接实际在线和参与的时间，这因行业而异。",
        },
        {
          claim: "互动 pod 有效",
          reality:
            "曾经有效。LinkedIn 的分类器现在会检测相同账户之间重复的交叉互动并贬值提升。真实的互动会扩展，人工的不会。",
        },
        {
          claim: "带图片的帖子总是赢",
          reality:
            "纯文本帖子通常胜过带有库存图片的帖子。重要的是停留时间 —— 如果图片不增加信号，它只会减慢阅读速度并降低钩子的有效性。",
        },
      ],
    },
    aiCta: {
      ...
      subtitle:
        "Posty 是在 2025 年和 2026 年数千个病毒式帖子上训练的。它生成针对上述信号校准的钩子、结构和 CTA —— 只需几秒钟。",
      button: "免费试用 Posty",
    },
    ...
    faq: [
      {
        ...
        answer:
          "对大多数创作者来说，每周 3 到 5 次是最佳点。如果您能保持质量，每天发布也可以 —— 但一个深思熟虑的帖子总是胜过五个仓促的帖子。数月的一致性比原始频率更重要。",
      },
      {
        question: "LinkedIn 算法会惩罚外部链接吗？",
        answer:
          "自 2026 年初以来不再。外部链接过去会自动限制覆盖率，但 LinkedIn 现在在决定之前会测量帖子本身的停留时间。如果您的帖子获得关注，链接会随之而来。",
      },
      {
        question: "在 LinkedIn 上发布的最佳时间是什么？",
        answer:
          "没有普遍的答案。查看您自己的分析以了解您的受众何时参与最多 —— 这因行业、国家和角色而异。周二至周四早晨适合大多数 B2B 受众。",
      },
      {
        question: "为什么有些帖子的浏览量为 0？",
        answer:
          "三个常见原因：垃圾邮件分类器标记了该帖子（主题标签堆砌、互动诱饵、AI 明显模式），种子受众在第一个小时内未参与，或者您的历史互动率太低以至于算法无法用足够的人来测试您。",
      },
      {
        question: "评论还是点赞更重要？",
        answer:
          "评论占主导地位。一个有实质内容的评论胜过 10 个点赞。原始评论者再次回复的互惠线程比一次性评论更有价值。",
      },
      {
      ...
      },
      {
        ...
        answer:
          "某人在继续滚动之前暂停在您的帖子上的时间长度。点击「查看更多」是最强的代理指标。保持注意力的长帖子胜过被略过的短帖子。",
      },
      {
        question: "LinkedIn 帖子会持续获得覆盖率多长时间？",
        answer:
          "大多数帖子在 24 小时内达到峰值并迅速衰减。病毒式帖子可以在 48 至 72 小时内继续累积展示次数。一个非常小的子集 —— 高度可分享的常青内容 —— 会持续数周获得互动。",
      },
    ],
    aboutAlgorithmLabel: "关于 LinkedIn 算法",
    internalLinks: [
      { label: "LinkedIn 帖子创意", href: "/linkedin-post-ideas" },
      { label: "LinkedIn 帖子示例", href: "/linkedin-post-examples" },
      { label: "LinkedIn 帖子生成器 AI", href: "/ai-linkedin-post-generator" },
      { label: "撰写 LinkedIn 帖子", href: "/write-linkedin-post" },
      { label: "免费注册", href: "/signup" },
    ],
    exploreMore: "更多资源",
    finalCta: {
      title: "理解算法。委派写作。",
      subtitle:
        "Posty 撰写针对此页面上确切信号校准的帖子 —— 用于停留时间的钩子、用于评论的结构、用于您细分领域的语气。免费生成您的第一个帖子。",
      button: "开始更好地写作",
    },
  },
  ...
  ja: {
    meta: {
      ...
      description:
        "2026 年の LinkedIn アルゴリズムによる投稿ランキングの仕組み — 4 つの配信フェーズ、5 つの主要シグナル、今年の変更点、そして今でも通用する 7 つの実証済み戦術。",
    },
    ...
    tldr: {
      label: "概要",
      body: "LinkedIn は各投稿を 4 フェーズでスコアリングします：品質チェック、シード受容者でのテスト、エンゲージメント評価、そしてシグナルが強ければバイラル配信。最も重要なシグナル（順番に）は、意味のあるコメント、ドウェルタイム、コンテンツの関連性、クリエイターの権威、接続の強さです。それ以外はノイズです。",
    },
    phasesSection: {
      title: "4 つの配信フェーズ",
      subtitle:
        "投稿は大きな受容者に到達する前に 4 つの自動チェックポイントを通過します。それぞれを理解することで、実際にどこでリーチを失っているかがわかります。",
      phases: [
        {
        ...
        },
        {
          title: "シード受容者テスト",
          description:
            "投稿はあなたのネットワークの一部（50 人から数百人）に表示されます — 接続の強さ、過去のエンゲージメント、トピックの関連性で選ばれます。このテストウィンドウの最初の 60 分が重要です。",
          outcomeLabel: "結果",
    ...
    signalsSection: {
      ...
      subtitle:
        "LinkedIn は多くの要因を考慮しています。実際には、これら 5 つが、1 つの投稿が離陸し、別の投稿が離陸しない理由の 90% を説明しています。",
      signals: [
        {
          emoji: "\u{1F4AC}",
          title: "意味のあるコメント",
          description:
            "絵文字ではなく、一言の返信ではありません。実質的なコメント — 特にやり取りを引き起こすもの — は、あなたのコンテンツが一時停止に値することを示します。最も重いポジティブシグナル単体。",
          weightLabel: "最高重み",
        },
        {
          emoji: "\u{23F1}\u{FE0F}",
          title: "ドウェルタイム",
          description:
            "人々があなたの投稿でスクロールを止める時間の長さ。注目を保つ長い投稿は、流し読みされる短い投稿に勝ります。「もっと見る」クリックは測定可能な代理指標です。",
          weightLabel: "高",
        },
        {
          emoji: "\u{1F3AF}",
          title: "コンテンツの関連性",
          description:
            "アルゴリズムはあなたのトピックを各視聴者の推測された興味と一致させます。一貫したニッチに留まる投稿はトピック権威を構築し、時間の経過とともにより厳密で関連性の高い受容者に表示されます。",
          weightLabel: "高",
        },
        {
          emoji: "\u{1F3C6}",
        ...
        },
        {
          ...
          title: "接続の強さ",
          description:
            "過去の相互作用で重み付けされます — 以前にあなたの投稿にいいねやコメントをした人は、シード受容者で優先されます。休眠中の連絡先との再接続は、早期ウィンドウのエンゲージメントにコストがかかります。",
          weightLabel: "中",
        },
      ],
    },
    recentChanges: {
      title: "2026 年に変わったこと",
      subtitle:
        "LinkedIn は配信を積極的に再調整しています。今年の 4 つの変更は、あなたが実際に投稿すべきものに最大の影響を与えます。",
      changes: [
        {
          label: "2026 年 Q1",
          title: "外部リンクペナルティが緩和",
        ...
        },
        {
          ...
          description:
            "ショート縦型ビデオ投稿（90 秒未満）は、テキストのみと比較して B2B/キャリアトピックで 2 〜 3 倍のリーチを見ています。最初の 3 秒のキャプションと強いフックは、制作品質よりも重要です。",
        },
        {
          label: "継続中",
          title: "AI 生成コンテンツの検出",
          description:
            "汎用的な AI パターン（過剰なリスト、定型的な冒頭、中身のないソートリーダーシップ）を持つ投稿は、ますます下位に置かれています。修正は具体性です：実名、実数、実体験。",
        },
        {
          label: "継続中",
          title: "コメント品質の重み付け",
          description:
            "12 語を超えるコメントは、短いコメントよりも大幅に重要です。相互コメントループ（ポッド）は依然として検出可能で、価値が下がっています — オーガニックな深さが勝ちます。",
        },
      ],
    },
    tipsSection: {
      ...
      subtitle:
        "ハックではありません。2025 年と 2026 年に分析された何千もの投稿でリーチと相関するパターンです。",
      tips: [
        {
          title: "最初の 60 分を制す",
          description:
        ...
        },
        {
          title: "最初の 2 行のフック",
          description:
            "「もっと見る」の前に表示される唯一の行です。具体的、予想外、またはやや逆張りな冒頭はクリックをトリガーします — LinkedIn はこれをドウェルタイムとして測定します。",
        },
        {
          title: "いいねだけでなくコメントをトリガー",
          description:
            "はい / いいえではなく意見が必要な質問で投稿を終えます。最初の 2 時間以内にすべてのコメントに返信してスレッドを生かし続けてください — スレッドの深さは強いシグナルです。",
        },
        {
          title: "週に 3 〜 5 回、一貫して投稿する",
          description:
            "クリエイターの権威は蓄積されます。月水金を 3 か月続けることは、第 1 週に 20 投稿してその後沈黙するよりも勝ります。LinkedIn は姿を現すクリエイターを報酬します。",
        },
        {
          title: "6 か月間、明確なニッチに留まる",
          description:
            "無関係なトピック間でジャンプすると、トピックの権威がリセットされます。狭い車線を選んでそれを支配してください — アルゴリズムは最終的にあなたの投稿を気にかける人々にプッシュします。",
        },
        {
        ...
        },
        {
          ...
          description:
            "定型的な「リーダーシップ」投稿、空虚なモチベーション、明らかな ChatGPT 構造は下位に置かれます。具体的なストーリー、珍しい意見、ユニークな経験が報酬されます。",
        },
      ],
    },
    mythsSection: {
      title: "よくある神話、事実確認済み",
      subtitle:
        "これらの主張は毎年広まります。実際のデータに対してはどれも持ちこたえません。",
      mythLabel: "神話",
      realityLabel: "現実",
      myths: [
        {
          ...
          reality:
            "3 〜 5 の関連ハッシュタグは問題ありません。それ以上、スパム分類器が作動し、配信を制限します。ハッシュタグは小さな関連性シグナルであり、リーチの乗数ではありません。",
        },
        {
          claim: "外部リンクはリーチを殺す",
          reality:
            "もうそうではありません。2026 年 Q1 以降、LinkedIn は制限を決定する前にドウェルタイムを測定します。コンテキストリンクを持つよく書かれた投稿は、実体のないリンクなし投稿を上回ります。",
        },
        {
        ...
        },
        {
          claim: "画像付きの投稿は常に勝つ",
          reality:
            "テキストのみの投稿は、ストック画像付きの投稿を上回ることがよくあります。重要なのはドウェルタイムです — 画像がシグナルを追加しない場合、読み取りを遅くし、フックの効果を減らすだけです。",
        },
      ],
    },
    aiCta: {
      ...
      subtitle:
        "Posty は 2025 年と 2026 年にバイラルになった何千もの投稿でトレーニングされています。上記のシグナル用に調整されたフック、構造、CTA を生成します — 数秒で。",
      button: "Posty を無料で試す",
    },
    ...
    faq: [
      ...
      },
      {
        ...
        answer:
          "コメントが優勢です。1 つの実質的なコメントは 10 個のいいねよりも価値があります。元のコメント者が再び返信する相互スレッドは、単発のコメントよりもはるかに価値があります。",
      },
      {
      ...
      },
      {
        ...
        answer:
          "誰かがスクロールする前に投稿で一時停止する時間の長さ。「もっと見る」クリックは最も強い代理指標です。注目を保つ長い投稿は、流し読みされる短い投稿に勝ります。",
      },
      {
    ...
    internalLinks: [
      { label: "LinkedIn 投稿アイデア", href: "/linkedin-post-ideas" },
      { label: "LinkedIn 投稿例", href: "/linkedin-post-examples" },
      { label: "LinkedIn 投稿ジェネレーター AI", href: "/ai-linkedin-post-generator" },
      { label: "LinkedIn 投稿を書く", href: "/write-linkedin-post" },
      { label: "無料登録", href: "/signup" },
    ],
    exploreMore: "その他のリソース",
    finalCta: {
      title: "アルゴリズムを理解。執筆を委託。",
      subtitle:
        "Posty はこのページの正確なシグナル用に調整された投稿を起草します — ドウェルタイム用のフック、コメント用の構造、ニッチ用のトーン。最初の投稿を無料で生成。",
      button: "より良い投稿を書き始める",
    },
  },
  ...
  ko: {
    meta: {
      ...
      description:
        "2026년 LinkedIn 알고리즘이 게시물을 순위 매기는 방법 — 4가지 배포 단계, 5가지 핵심 신호, 올해 변경된 것, 그리고 여전히 효과적인 7가지 검증된 전술.",
    },
    ...
    tldr: {
      label: "요약",
      body: "LinkedIn은 각 게시물을 4단계로 점수를 매깁니다: 품질 검사, 소규모 시드 오디언스에서의 테스트, 참여도 평가, 그리고 신호가 강하면 바이럴 배포. 가장 중요한 신호 — 순서대로 — 는 의미 있는 댓글, 체류 시간, 콘텐츠 관련성, 크리에이터 권위, 연결 강도입니다. 그 외의 것은 잡음입니다.",
    },
    phasesSection: {
      title: "4가지 배포 단계",
      subtitle:
        "게시물은 대규모 오디언스에 도달하기 전에 4개의 자동 체크포인트를 통과합니다. 각각을 이해하면 실제로 어디서 도달을 잃는지 알 수 있습니다.",
      phases: [
        {
          title: "품질 검사 (스팸 필터)",
          description:
        ...
        },
        {
          title: "시드 오디언스 테스트",
          description:
            "게시물은 네트워크의 작은 부분(50명에서 수백 명)에 표시됩니다 — 연결 강도, 과거 참여도, 주제 관련성에 따라 선택됩니다. 이 테스트 창의 처음 60분이 중요합니다.",
          outcomeLabel: "결과",
    ...
    signalsSection: {
      ...
      subtitle:
        "LinkedIn은 수십 가지 요인을 고려합니다. 실제로 이 5가지가 한 게시물이 뜨고 다른 게시물이 뜨지 않는 이유의 90%를 설명합니다.",
      signals: [
        {
          emoji: "\u{1F4AC}",
          title: "의미 있는 댓글",
          description:
            "이모지가 아니며, 한 단어 답변이 아닙니다. 실질적인 댓글 — 특히 주고받음을 유발하는 것 — 은 콘텐츠가 잠시 멈출 가치가 있음을 알립니다. 가장 무거운 단일 긍정적 신호입니다.",
          weightLabel: "최대 가중치",
        },
        {
          emoji: "\u{23F1}\u{FE0F}",
          title: "체류 시간",
          description:
            "사람들이 게시물에서 스크롤을 멈추는 시간. 주의를 끄는 긴 게시물이 훑어보는 짧은 게시물을 이깁니다. '더 보기' 클릭은 측정 가능한 프록시입니다.",
          weightLabel: "높음",
        },
        {
          emoji: "\u{1F3AF}",
          title: "콘텐츠 관련성",
          description:
            "알고리즘은 주제를 각 시청자의 추론된 관심사와 일치시킵니다. 일관된 틈새에 머무는 게시물은 주제 권위를 구축하고 시간이 지남에 따라 더 긴밀하고 관련성 있는 오디언스에 표시됩니다.",
          weightLabel: "높음",
        },
        {
          emoji: "\u{1F3C6}",
          title: "크리에이터 권위",
          description:
            "LinkedIn은 과거 참여율, 게시 빈도, 네트워크 품질을 추적합니다. 견고한 참여도를 가진 일관된 크리에이터는 모든 게시물에서 기본 부스트를 받습니다.",
          weightLabel: "중간",
        },
        {
          emoji: "\u{1F517}",
    ...
    recentChanges: {
      title: "2026년에 변경된 것",
      subtitle:
        "LinkedIn은 배포를 공격적으로 재조정하고 있습니다. 올해의 4가지 변경 사항은 실제로 게시해야 할 것에 가장 큰 영향을 미칩니다.",
      changes: [
        {
          label: "2026년 1분기",
          title: "외부 링크 페널티 완화",
        ...
        },
        {
          ...
          description:
            "짧은 세로 동영상 게시물(90초 미만)은 텍스트 전용 대비 B2B/경력 주제에서 2~3배의 도달을 보입니다. 처음 3초의 캡션과 강력한 훅은 제작 품질보다 더 중요합니다.",
        },
        {
          label: "진행 중",
          title: "AI 생성 콘텐츠 감지",
          description:
            "일반적인 AI 패턴(과도한 목록, 상용구 시작, 속 빈 사상 리더십)이 있는 게시물은 점점 순위가 내려갑니다. 해결책은 구체성입니다: 실명, 실수, 실제 체험.",
        },
        {
          label: "진행 중",
          title: "댓글 품질 가중치",
          description:
            "12 단어를 초과하는 댓글은 짧은 댓글보다 훨씬 더 많이 계산됩니다. 상호 댓글 루프(포드)는 여전히 감지 가능하며 가치가 떨어집니다 — 유기적 깊이가 이깁니다.",
        },
      ],
    },
    tipsSection: {
      ...
      subtitle:
        "해킹이 아닙니다. 2025년과 2026년에 분석된 수천 개의 게시물에서 도달과 상관관계를 보이는 패턴입니다.",
      tips: [
        {
          title: "처음 60분을 확보",
          description:
            "핵심 오디언스가 실제로 온라인일 때 게시하세요. 게시물이 첫 시간에 얻는 참여도가 시드 오디언스 테스트를 탈출할지 결정합니다. 개인 피크 창을 위해 분석을 확인하세요.",
        },
        {
          title: "처음 2줄의 훅",
          description:
            "'더 보기' 전에 보이는 유일한 줄입니다. 구체적이거나 예상치 못하거나 약간 반대되는 시작은 클릭을 유발합니다 — LinkedIn은 이를 체류 시간으로 측정합니다.",
        },
        {
          title: "좋아요뿐 아니라 댓글을 유발",
          description:
            "예/아니오가 아니라 의견이 필요한 질문으로 게시물을 끝내세요. 처음 2시간 동안 모든 댓글에 답하여 스레드를 생생하게 유지하세요 — 스레드 깊이는 강한 신호입니다.",
        },
        {
          title: "일관되게 주 3~5회 게시",
          description:
            "크리에이터 권위는 누적됩니다. 3개월 동안 월-수-금에 게시하는 것이 1주차에 20개를 게시한 후 침묵하는 것을 이깁니다. LinkedIn은 나타나는 크리에이터에게 보상합니다.",
        },
        {
          title: "6개월 동안 명확한 틈새에 머물기",
          description:
            "관련 없는 주제 사이를 뛰어다니면 주제 권위가 재설정됩니다. 좁은 차선을 선택하고 그것을 지배하세요 — 알고리즘은 결국 관심 있는 사람들에게 게시물을 푸시할 것입니다.",
        },
        {
          title: "리포스트가 아닌 네이티브 형식 사용",
          description:
            "원본 텍스트, 네이티브 동영상, 네이티브 문서, 네이티브 투표는 모두 링크 공유를 능가합니다. 특히 문서(PDF 캐러셀)는 매우 높은 평균 체류 시간을 가집니다.",
        },
        {
          title: "LinkedIn처럼이 아닌 사람처럼 쓰기",
          description:
            "공식화된 '리더십' 게시물, 속 빈 동기 부여, 명백한 ChatGPT 구조는 순위가 내려갑니다. 구체적인 이야기, 특이한 의견, 독특한 경험이 보상됩니다.",
        },
      ],
    },
    mythsSection: {
      title: "일반적인 신화, 사실 확인",
      subtitle:
        "이러한 주장은 매년 퍼집니다. 실제 데이터에 대해 어느 것도 버티지 못합니다.",
      mythLabel: "신화",
      realityLabel: "현실",
      myths: [
        {
          ...
          reality:
            "3~5개의 관련 해시태그는 괜찮습니다. 그 이상이면 스팸 분류기가 켜지고 배포를 제한합니다. 해시태그는 작은 관련성 신호이며 도달 승수가 아닙니다.",
        },
        {
          claim: "외부 링크는 도달을 죽인다",
          reality:
            "더 이상 아닙니다. 2026년 1분기 이후 LinkedIn은 제한 결정 전에 체류 시간을 측정합니다. 맥락 링크가 있는 잘 쓰인 게시물은 실체 없는 링크 없는 게시물을 능가합니다.",
        },
        {
          claim: "게시하기에 가장 좋은 시간이 있다",
          reality:
            "당신의 오디언스에게 가장 좋은 시간이 있습니다. 일반적인 '화요일 오전 8시' 조언은 가치가 없습니다 — 연결이 실제로 온라인이고 참여할 때를 확인하세요. 산업별로 크게 다릅니다.",
        },
        {
          claim: "참여 포드가 작동한다",
          reality:
            "작동했습니다. LinkedIn의 분류기는 이제 동일한 계정 간의 반복되는 크로스 참여를 감지하고 부스트 값을 내립니다. 실제 참여도는 확장되며 인공적인 것은 그렇지 않습니다.",
        },
        {
          claim: "이미지가 있는 게시물은 항상 이긴다",
          reality:
            "텍스트 전용 게시물은 종종 스톡 이미지가 있는 게시물을 능가합니다. 중요한 것은 체류 시간입니다 — 이미지가 신호를 추가하지 않으면 읽기를 늦추고 훅 효과를 줄일 뿐입니다.",
        },
      ],
    },
    aiCta: {
      ...
      subtitle:
        "Posty는 2025년과 2026년에 바이럴이 된 수천 개의 게시물로 훈련되었습니다. 위의 신호에 맞춰 조정된 훅, 구조, CTA를 몇 초 만에 생성합니다.",
      button: "Posty 무료로 시도",
    },
    ...
    faq: [
      ...
      },
      {
        ...
        answer:
          "댓글이 우세합니다. 하나의 실질적인 댓글은 10개의 좋아요보다 가치가 있습니다. 원래 댓글 작성자가 다시 답하는 상호 스레드는 일회성 댓글보다 훨씬 더 가치가 있습니다.",
      },
      {
      ...
      },
      {
        ...
        answer:
          "누군가가 스크롤하기 전에 게시물에서 일시 중지하는 시간. '더 보기' 클릭은 가장 강한 프록시입니다. 주의를 끄는 긴 게시물은 훑어보는 짧은 게시물을 이깁니다.",
      },
      {
    ...
    internalLinks: [
      { label: "LinkedIn 게시물 아이디어", href: "/linkedin-post-ideas" },
      { label: "LinkedIn 게시물 예제", href: "/linkedin-post-examples" },
      { label: "LinkedIn 게시물 생성기 AI", href: "/ai-linkedin-post-generator" },
      { label: "LinkedIn 게시물 작성", href: "/write-linkedin-post" },
    ...
    finalCta: {
      ...
      subtitle:
        "Posty는 이 페이지의 정확한 신호에 맞춰 조정된 게시물을 작성합니다 — 체류 시간을 위한 훅, 댓글을 위한 구조, 틈새를 위한 톤. 첫 게시물을 무료로 생성하세요.",
...
function stringifyValue(v, indent) {
  ...
  if (typeof v === "string") {
    // Use multi-line string if very long, otherwise single-line.
    if (v.length > 100) {
      return `\n${inner}"${escape(v)}"`;
    }
    return `"${escape(v)}"`;
  ...
  if (Array.isArray(v)) {
    const items = v.map((x) => `${inner}${stringifyValue(x, indent + 1)}`).join(",\n");
    return `[\n${items},\n${pad}]`;
  }
  if (v && typeof v === "object") {
    const entries = Object.entries(v)
      .map(([k, val]) => `${inner}${k}: ${stringifyValue(val, indent + 1)}`)
      .join(",\n");
    return `{\n${entries},\n${pad}}`;
  }
...
function formatLang(lang, data) {
  const indent = 1;
  return `  ${lang}: ${stringifyValue(data, indent + 1)}`;
}
...
// Idempotence
if (src.includes("\n  de: {")) {
  console.log("[SKIP] de: already present, aborting");
  process.exit(0);
}

const newBlocks = Object.entries(langs)
  .map(([lang, data]) => formatLang(lang, data))
  .join(",\n\n");
...
const updated = src.replace(anchor, `,\n\n${newBlocks},\n};\n`);
fs.writeFileSync(FILE_PATH, updated);
console.log(`[OK] Injected 8 languages (${Object.keys(langs).join(", ")})`);
