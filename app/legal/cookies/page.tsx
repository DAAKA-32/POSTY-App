    ...
    <LegalLayoutLight title={cookies.title}>
      ...
      <section className="mb-8">
        ...
        <div className="mb-6">
          ...
          <p className="text-gray-300 mb-3">{cookies.section2.functional.description}</p>
          <div className="overflow-x-auto">
            <table className="w-full text-sm text-gray-300">
              <thead>
                <tr className="border-b border-dark-border text-left">
        ...
        <div className="mb-6">
          ...
          <p className="text-gray-300 mb-3">{cookies.section2.analytics.description}</p>
          <div className="overflow-x-auto">
            <table className="w-full text-sm text-gray-300">
              <thead>
                <tr className="border-b border-dark-border text-left">
          ...
          <div className="mt-3 p-3 bg-primary/10 border border-primary/20 rounded-lg">
            <p className="text-sm text-gray-300">{cookies.section2.analytics.noThirdParty}</p>
          </div>
        </div>
        ...
        <div className="mb-6">
          ...
          <p className="text-gray-300 mb-3">{cookies.section2.thirdParty.description}</p>
          <div className="overflow-x-auto">
            <table className="w-full text-sm text-gray-300">
              <thead>
                <tr className="border-b border-dark-border text-left">
          ...
          <p className="text-gray-400 text-sm mt-3">{cookies.section2.thirdParty.note}</p>
        </div>
      </section>
      ...
      <section className="mb-8">
        ...
        <p className="text-gray-300 mb-4">{cookies.section3.intro}</p>
