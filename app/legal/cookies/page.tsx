    ...
    <LegalLayoutLight title={cookies.title}>
      ...
      <section className="mb-8">
        ...
        <div className="mb-6">
          ...
          <p className="text-gray-100 mb-3">{cookies.section2.functional.description}</p>
          <div className="overflow-x-auto">
            <table className="w-full text-sm text-gray-100">
              <thead>
                <tr className="border-b border-dark-border text-left">
        ...
        <div className="mb-6">
          ...
          <p className="text-gray-100 mb-3">{cookies.section2.analytics.description}</p>
          <div className="overflow-x-auto">
            <table className="w-full text-sm text-gray-100">
              <thead>
                <tr className="border-b border-dark-border text-left">
          ...
          <div className="mt-3 p-3 bg-primary/10 border border-primary/20 rounded-lg">
            <p className="text-sm text-gray-100">{cookies.section2.analytics.noThirdParty}</p>
          </div>
        </div>
        ...
        <div className="mb-6">
          ...
          <p className="text-gray-100 mb-3">{cookies.section2.thirdParty.description}</p>
          <div className="overflow-x-auto">
            <table className="w-full text-sm text-gray-100">
              <thead>
                <tr className="border-b border-dark-border text-left">
          ...
          <p className="text-gray-300 text-sm mt-3">{cookies.section2.thirdParty.note}</p>
        </div>
      </section>
      ...
      <section className="mb-8">
        ...
        <p className="text-gray-100 mb-4">{cookies.section3.intro}</p>
        <div className="space-y-3">
          {cookies.section3.methods.map((method, i) => (
            <div key={i} className="bg-dark-card border border-dark-border rounded-lg p-4">
              ...
              <p className="text-gray-300 text-sm">{method.desc}</p>
            </div>
          ))}
        </div>
      </section>
