...
export default function DeleteAccountModal({
  ...
  const formContent = (
    <form onSubmit={handleSubmit} className="space-y-5">
        ...
        <div>
          ...
          <div className="relative">
            <input
              ...
              className={`
                w-full px-4 py-3 pr-12 bg-gray-100 dark:bg-dark-bg border rounded-xl text-gray-900 dark:text-white
                placeholder-gray-400 dark:placeholder-text-muted focus:outline-none focus:ring-2 transition-all
                ${error
                  ? "border-error focus:ring-error/50 focus:border-error"
                  : "border-gray-300 dark:border-dark-border focus:ring-primary/50 focus:border-primary"
                }
            ...
            <button
              ...
              className="absolute right-1 top-1/2 -translate-y-1/2 min-w-[44px] min-h-[44px] flex items-center justify-center text-gray-400 dark:text-text-muted hover:text-gray-900 dark:hover:text-white transition-colors rounded-lg hover:bg-gray-200 dark:hover:bg-dark-hover"
              tabIndex={-1}
            >
              {showPassword ? (
      ...
      {/* Google user message */}
      {isGoogleUser && (
        <div className="p-4 bg-gray-100 dark:bg-dark-bg border border-gray-300 dark:border-dark-border rounded-xl">
          <div className="flex items-center gap-3">
            <svg className="w-6 h-6 text-gray-600 dark:text-text-secondary" viewBox="0 0 24 24">
  ...
  const content = step === "success" ? successContent : formContent;
